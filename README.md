...
namespace CustomMacroPlugin0.GameListSample
{
    ...
    partial class Game_Sample1 : MacroBase
    {
        ...
        public override void Init()
        {
            ...
            MainGate.Add(CreateGateBase("Sacred Relic Sword V3", groupName: "jmB!$h@T"));
        }
...
namespace CustomMacroPlugin0.GameListSample
{
    ...
    partial class Game_Sample2
    {
        ...
        {
            Macro0_Flow.Start_Condition = RealDS4.Square; //Activated by pressing □
            Macro0_Flow.Stop_Condition = RealDS4.Square is false; //Termination upon releasing □ button.
    ...
    partial class Game_Sample2
    {
        ...
        private void Macro1()
        {
            ...
            Macro1_Flow.Stop_Condition = RealDS4.Circle is false;  //Termination upon releasing ○ button.
